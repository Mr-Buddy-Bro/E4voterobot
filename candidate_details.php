...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light p-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href=".\admin_cpanel.php" class="nav-item nav-link">Admin</a>
                            <a href="candidate_details.php?filter=0" class="nav-item nav-link active">Candiate Details</a>
    ...
    <div class="cen_content">
        <h1>Candidates <button onclick="on_add_candidate()" style="color: white; text-align: center;font-size: 18px; margin: 30px 0; padding: 8px 25px; border-color: #8f7528; cursor: pointer; background-color: #8f7528; border-radius: 10px;">Add Candidate</button></h1>
    ...
    function onfilter(){
        ...
        window.location.assign("./candidate_details.php?filter="+filt);
    }
    function on_save(){
